//Credits to Abdullah Aldandarawy. Book - Page Curl Asset
...
public class Book : MonoBehaviour {
    ...
    void Start() {
        ...
        fadeIn = true;
        fadeObj.SetScreenOverlayColor(new Color(0, 0, 0));
    ...
    void Update() {
        ...
        if(Input.GetKeyUp(KeyCode.Space)) {
            if (!descriptionToggle) {
                fadeObj.SetScreenOverlayColor(new Color(0, 0, 0, 0.8f));
                descriptionToggle = true;
            } else if (descriptionToggle) {
                fadeObj.SetScreenOverlayColor(new Color(0, 0, 0, 0));
                descriptionToggle = false;
            }
        }
        ...
        //    cam.orthographicSize = Mathf.Clamp(cam.orthographicSize + Input.GetAxis("Mouse ScrollWheel") * 10, 25, 60);
        //}
    }
    ...
    void OnGUI() {
        GUI.depth = 2;
        GUI.Label(new Rect(Screen.width / 2 - 50, 25, 100, 20), "Press E to Close", style);
        GUI.Label(new Rect(Screen.width / 2 - 550, 55, 300, 20), "Click + drag bottom corners to interact", style);
        GUI.Label(new Rect(Screen.width / 2 - 100, 55, 300, 20), "Or Left + Right Arrows to flip", style);
        GUI.Label(new Rect(Screen.width / 2 + 250, 55, 300, 20), "Press Space to toggle brief descriptions", style);
        GUI.Label(new Rect(Screen.width / 2 + 325, 35, 300, 20), "(Not fully implemented)", style);
    }
